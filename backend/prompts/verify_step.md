...
If it fails, `hint` is ONE short spoken sentence in {{language}} that nudges them toward the right action without doing it for them, based on what you can see they did. If it passes, `hint` is a short, warm, specific word of praise (vary it).
