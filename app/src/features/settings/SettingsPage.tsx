...
import { AccessNotice } from "../billing/AccessNotice";
    ...
    <div className="grid gap-10 px-14 pt-9 pb-10 min-[900px]:grid-cols-[200px_1fr]">
      <div>
        <nav
          ...
          className="flex gap-1 min-[900px]:flex-col"
        >
          {SECTIONS.map((s) => (
            <button
              key={s}
              ...
              className={`rounded-lg px-3 py-2 text-left text-[13px] ${
                s === section
                  ? "border border-line bg-paper font-medium text-ink"
        ...
        <div className="mt-4 px-3 min-[900px]:mt-6">
          <AccessNotice />
        </div>
      </div>
